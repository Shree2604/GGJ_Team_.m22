...
background_menu = [pygame.transform.scale(pygame.image.load(abs_path('images/backgrounds/gifMenu-0.png')), (screen_width, screen_height)),
                   ...
                   pygame.transform.scale(pygame.image.load(abs_path('images/backgrounds/gifMenu-2.png')), (screen_width, screen_height)),
                   pygame.transform.scale(pygame.image.load(abs_path('images/backgrounds/gifMenu-3.png')), (screen_width, screen_height))]
...
def gameOver():
    if action['satiety'] <= 85 or action['toilet'] <= 85 or action['happy'] <= 85 or action['health'] <= 85:
...
help_menu = panelClass.Panel(400, 250, 750, 450, abs_path('images/sprites/panel_brown.png'), ' You have to keep the indicators normal.',
                             'If at least one of them is equal to 85, you will lose.', 'Good Luck!')
...
def game():
    ...
    while not endGame:
        ...
        statistics = statisticsClass.Statistics(400, 250, 750, 450, abs_path('images/sprites/panel_brown.png'),
                                                str(action['logiki']) + ' Lg', 'Name: Froggy', f'Days: {daysCount}')
